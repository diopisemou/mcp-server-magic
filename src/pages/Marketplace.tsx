...
import { Search, Package, Server, Globe, Info } from 'lucide-react';
...
export default function Marketplace() {
  ...
  const allTags = Array.from(new Set(mockServers.flatMap(server => server.tags)));
              ...
              <Card className="h-full hover:shadow-md transition-shadow">
                ...
                <CardFooter className="pt-0">
                  <div className="flex justify-between w-full text-xs">
                    ...
                    <span className="text-primary">{server.capabilities.length} capabilities</span>
                  </div>
                </CardFooter>
              </Card>
            </Link>
