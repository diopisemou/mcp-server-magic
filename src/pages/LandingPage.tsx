          ...
          <div className="content-container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              {[
                ...
                <div
                  key={index}
                  className={`rounded-xl overflow-hidden transition-transform hover:-translate-y-1 ${plan.highlight
                ...
                >
                  <div className="p-6">
                    ...
                    <Button
                      className={`w-full rounded-lg ${plan.highlight ? 'bg-white text-primary hover:bg-white/90' : ''
                        }`}
