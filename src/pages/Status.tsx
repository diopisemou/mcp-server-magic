...
export default function Status() {
  ...
  const [incidents, setIncidents] = useState<
    { date: string; description: string; resolved: boolean }[]
  >([
    {
      date: "2025-02-15",
  ...
  const [overallStatus, setOverallStatus] = useState<ServiceStatus>(
    "operational",
  );
  ...
  useEffect(() => {
    ...
    const fetchStatus = async () => {
      ...
      if (Math.random() > 0.8) {
        ...
        updatedServices[randomIndex].status = Math.random() > 0.5
          ? "degraded"
          : "operational";
                  ...
                  <div key={index} className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center">
                        ...
                        <span
                          className={cn("ml-2", getStatusColor(service.status))}
                        >
